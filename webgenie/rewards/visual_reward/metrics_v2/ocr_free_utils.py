...
def get_files_to_screenshot(image_path):
    ...
    return [p_html, p_html_1], [p_png, p_png_1]

def get_blocks_ocr_free(image_path, page_load_time, pre_screenshoted = False):
    html, p_html, p_html_1, p_png, p_png_1 = get_itermediate_names(image_path)
    
    if not pre_screenshoted:
        process_html(html, p_html)
        process_html(html, p_html_1, offset=50)
